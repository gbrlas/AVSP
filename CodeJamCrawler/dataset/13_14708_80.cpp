...
string input_file_large = "A-large.in";
string output_file_large = "A-large.out";
...
int main()
{
    FileGuard<ifstream> input_guard(in, input_file_large);
    FileGuard<ofstream> output_guard(out, output_file_large);
