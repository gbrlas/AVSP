...
public class ProblemB {
	...
	public ProblemB() throws Exception {
		BufferedReader in = new BufferedReader(new FileReader("input_b_large.txt"));
		PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("output_b_large.txt")));
