...
void MatchPattern(char Dictionary[5000][17],struct Node *Tokens[],int *Count, int L,int D)
{
...
void main()
{
	...
	char Dictionary[5000][17];
	struct Node *Tokens[16];
	char Tempchar, c;
	...
	fpOut = fopen("Large-Alien-Number-Output.in","w");
