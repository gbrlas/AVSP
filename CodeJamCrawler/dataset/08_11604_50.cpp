...
int main(void) {
    ...
    int n,na,nb,t,x;
    char adt[30][10],bdt[30][10],aat[30][10],bat[30][10];
    int atrain[30],btrain[30],ause[30],buse[30];
    scanf("%d",&n);
    for(x=0;x<n;x++) {
        memset(atrain,0,30*sizeof(int));
        memset(btrain,0,30*sizeof(int));
        memset(ause,0,30*sizeof(int));
        memset(buse,0,30*sizeof(int));
        int anum=0,bnum=0;
        scanf("%d",&t);
        scanf("%d %d",&na,&nb);
        int i,j;
