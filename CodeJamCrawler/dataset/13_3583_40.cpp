...
public class TicTacToe {
	public static void main(String...args) {
		...
		try {
			...
			br = new BufferedReader(new FileReader(System.getProperty("user.home") + "\\A-large.in"));

			bw = new BufferedWriter(new FileWriter(System.getProperty("user.home") + "\\A-large.out"));
