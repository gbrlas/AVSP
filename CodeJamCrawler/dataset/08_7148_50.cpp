...
public class SavingTheUniverse {
    public static void main(String[] args) throws IOException {
        File input = new File("/home/visibletrap/Desktop/A-small-attempt2.in");
        FileWriter output = new FileWriter(new File("/home/visibletrap/Desktop/A-small-attempt2.out"));
