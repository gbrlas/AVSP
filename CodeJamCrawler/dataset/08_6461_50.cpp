...
/**
 * <p>Google code jam 2008. Fly Swatter</p>
 *
...
//            System.out.println("----------Counting cell:"+x+","+y);
...
//            System.out.println("----Counting above cell:"+x+","+y);
            double area = 0;
            double toAdd = 0;
            do {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            if (innerR > 0 && cellSize > 0) {
                ...
                prob = 1 - fixedRaquet.area() / bigArea;
            }
            out.println(String.format(Locale.ENGLISH,"Case #"+i+": %7.6f", prob));
        }
