	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 try {
	            ...
	            BufferedReader reader = new BufferedReader(new FileReader("E:\\CODE PRACTICE\\codejam\\B-small-attempt0.in"));
	            BufferedWriter writer = new BufferedWriter(new FileWriter("E:\\CODE PRACTICE\\codejam\\bs.out"));
