...
public class Magicka {
	...
	public static void main(String[] args) throws Exception {
		...
		Scanner s = new Scanner(new File("data/gcj2011/qualificationround/B-large.in"));
		int T = s.nextInt();
		for (int t=1; t<=T; t++) {
...
//						System.out.printf("elems in list opposed: %c is opposed to %s; list contains %s%n", e, opposed.get(e), opposedTo);
					}
				}
			}
